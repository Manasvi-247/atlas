...
/**
 * Sun/moon theme switch (adapted from Uiverse.io by rishichawda).
 * Class-scoped (`.tt-*`) instead of id-scoped so it can render in more than one
 * place without duplicate-id clashes. Drives the global light/dark theme.
 */
export function ThemeToggle() {
  ...
  // Mirror the pre-paint <html> class into the store on mount.
  useEffect(() => {
    sync();
  }, [sync]);
  ...
  return (
    <label className="theme-toggle" title={dark ? "Switch to light" : "Switch to dark"}>
      <input type="checkbox" checked={dark} onChange={toggle} aria-label="Toggle dark mode" />
      <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(3.5 3.5)">
          <g filter="url(#container)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <rect className="tt-container" fill="#83cbd8" transform="translate(3.5 3.5)" rx="17.5" height="35" width="60.667" />
          </g>

          <g className="tt-button" transform="translate(2.333 2.333)">
            <g className="tt-sun">
            ...
            <g className="tt-moon">
              ...
              <g className="tt-patches" fill="#a6cad0" transform="translate(-24.415 -1.009)">
          ...
          <g className="tt-cloud" filter="url(#cloud)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
          ...
          <g className="tt-stars" fill="#def8ff" transform="translate(3.585 1.325)">
